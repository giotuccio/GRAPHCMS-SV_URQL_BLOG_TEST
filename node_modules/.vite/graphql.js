...
function extendSchemaImpl(schemaConfig, documentAST, options) {
  ...
  function replaceDirective(directive) {
    ...
    return new GraphQLDirective(__spreadProps(__spreadValues({}, config), {
  ...
  function extendInputObjectType(type) {
    ...
    return new GraphQLInputObjectType(__spreadProps(__spreadValues({}, config), {
      fields: () => __spreadValues(__spreadValues({}, mapValue(config.fields, (field) => __spreadProps(__spreadValues({}, field), {
  ...
  function extendEnumType(type) {
    ...
    return new GraphQLEnumType(__spreadProps(__spreadValues({}, config), {
  ...
  function extendScalarType(type) {
    ...
    return new GraphQLScalarType(__spreadProps(__spreadValues({}, config), {
      specifiedByURL,
      extensionASTNodes: config.extensionASTNodes.concat(extensions)
    }));
  }
  function extendObjectType(type) {
    ...
    return new GraphQLObjectType(__spreadProps(__spreadValues({}, config), {
      interfaces: () => [
        ...type.getInterfaces().map(replaceNamedType),
        ...buildInterfaces(extensions)
      ],
      fields: () => __spreadValues(__spreadValues({}, mapValue(config.fields, extendField)), buildFieldMap(extensions)),
      extensionASTNodes: config.extensionASTNodes.concat(extensions)
    }));
  }
  function extendInterfaceType(type) {
    ...
    return new GraphQLInterfaceType(__spreadProps(__spreadValues({}, config), {
      interfaces: () => [
        ...type.getInterfaces().map(replaceNamedType),
        ...buildInterfaces(extensions)
      ],
  ...
  function extendUnionType(type) {
    ...
    return new GraphQLUnionType(__spreadProps(__spreadValues({}, config), {
      types: () => [
...
function buildASTSchema(documentAST, options) {
  ...
  return new GraphQLSchema(__spreadProps(__spreadValues({}, config), { directives }));
}
...
function stringifyValue(value, type) {
  ...
  const sortedAST = visit(ast, {
    ObjectValue(objectNode) {
      ...
      return __spreadProps(__spreadValues({}, objectNode), { fields });
    }
  });
